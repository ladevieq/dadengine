...
namespace DadEngine
{
    ...
    */
    ...
    void __stdcall glVertexAttribPointer(GLuint _InIndex,
                                         GLint _InSize,
                                         GLenum _InType,
                                         GLboolean _InNormalized,
                                         GLsizei _InStride,
                                         const void *_InPointer)
    {
        PFNglVertexAttribPointer(_InIndex, _InSize, _InType, _InNormalized,
                                 _InStride, _InPointer);
    }
    ...
    void __stdcall glShaderSource(GLuint _InShaderID,
                                  GLsizei _InCount,
                                  const GLchar *const *_InShaderSource,
                                  GLint *_InLength)
    {
    ...
    void __stdcall glGetShaderInfoLog(GLuint _InShaderID,
                                      GLsizei _InBufferSize,
                                      GLsizei *_InLength,
                                      GLchar *_InInfoLog)
    {
    ...
    void __stdcall glBindFragDataLocation(GLuint _InProgramID,
                                          GLuint _InBindIndex,
                                          const char *_InBindName)
    {
    ...
    void __stdcall glGetProgramInfoLog(GLuint _InProgramID,
                                       GLsizei _InBufferSize,
                                       GLsizei *_InLength,
                                       GLchar *_InInfoLog)
    {
    ...
    void __stdcall glUniformMatrix4fv(GLint _InLocation,
                                      GLsizei _InCount,
                                      GLboolean _InTranspose,
                                      const float *_InValue)
    {
    ...
    */
    void glLoadStandardFunctions()
    {
        ...
        PFNglDrawBuffers =
            (PFNGLDRAWBUFFERSPROC)glLoadFunction("glDrawBuffers");

        PFNglDeleteBuffers =
            (PFNGLDELETEBUFFERSPROC)glLoadFunction("glDeleteBuffers");


        // Vertex buffer stuff
        PFNglGenVertexArrays =
            (PFNGLGENVERTEXARRAYSPROC)glLoadFunction("glGenVertexArrays");

        PFNglBindVertexArray =
            (PFNGLBINDVERTEXARRAYPROC)glLoadFunction("glBindVertexArray");

        PFNglVertexAttribPointer = (PFNGLVERTEXATTRIBPOINTERPROC)glLoadFunction("glVertexAttribPointer");

        PFNglEnableVertexAttribArray = (PFNGLENABLEVERTEXATTRIBARRAYPROC)glLoadFunction(
            "glEnableVertexAttribArray");

        PFNglDisableVertexAttribArray = (PFNGLDISABLEVERTEXATTRIBARRAYPROC)glLoadFunction(
            "glDisableVertexAttribArray");

        PFNglDeleteVertexArrays =
            (PFNGLDELETEVERTEXARRAYSPROC)glLoadFunction("glDeleteVertexArrays");


        // Shader stuff
        PFNglCreateShader =
            (PFNGLCREATESHADERPROC)glLoadFunction("glCreateShader");

        PFNglShaderSource =
            (PFNGLSHADERSOURCEPROC)glLoadFunction("glShaderSource");

        PFNglCompileShader =
            (PFNGLCOMPILESHADERPROC)glLoadFunction("glCompileShader");

        PFNglAttachShader =
            (PFNGLATTACHSHADERPROC)glLoadFunction("glAttachShader");

        PFNglDetachShader =
            (PFNGLDETACHSHADERPROC)glLoadFunction("glDetachShader");

        PFNglGetShaderiv =
            (PFNGLGETSHADERIVPROC)glLoadFunction("glGetShaderiv");

        PFNglGetShaderInfoLog =
            (PFNGLGETSHADERINFOLOGPROC)glLoadFunction("glGetShaderInfoLog");

        PFNglDeleteShader =
            (PFNGLDELETESHADERPROC)glLoadFunction("glDeleteShader");


        // Shader program stuff
        PFNglCreateProgram =
            (PFNGLCREATEPROGRAMPROC)glLoadFunction("glCreateProgram");

        PFNglLinkProgram =
            (PFNGLLINKPROGRAMPROC)glLoadFunction("glLinkProgram");

        PFNglUseProgram = (PFNGLUSEPROGRAMPROC)glLoadFunction("glUseProgram");

        PFNglBindAttribLocation =
            (PFNGLBINDATTRIBLOCATIONPROC)glLoadFunction("glBindAttribLocation");

        PFNglBindFragDataLocation = (PFNGLBINDFRAGDATALOCATIONPROC)glLoadFunction(
            "glBindFragDataLocation");

        PFNglGetProgramiv =
            (PFNGLGETPROGRAMIVPROC)glLoadFunction("glGetProgramiv");

        PFNglGetProgramInfoLog =
            (PFNGLGETPROGRAMINFOLOGPROC)glLoadFunction("glGetProgramInfoLog");

        PFNglDeleteProgram =
            (PFNGLDELETEPROGRAMPROC)glLoadFunction("glDeleteProgram");

        // Uniforms variable functions
        PFNglGetUniformLocation =
            (PFNGLGETUNIFORMLOCATIONPROC)glLoadFunction("glGetUniformLocation");

        PFNglUniform4fv = (PFNGLUNIFORM4FVPROC)glLoadFunction("glUniform4fv");

        PFNglUniformMatrix4fv =
            (PFNGLUNIFORMMATRIX4FVPROC)glLoadFunction("glUniformMatrix4fv");


        // Framebuffer stuff
        PFNglGenFramebuffers =
            (PFNGLGENFRAMEBUFFERSPROC)glLoadFunction("glGenFramebuffers");

        PFNglBindFramebuffer =
            (PFNGLBINDFRAMEBUFFERPROC)glLoadFunction("glBindFramebuffer");

        PFNglDeleteFramebuffers =
            (PFNGLDELETEFRAMEBUFFERSPROC)glLoadFunction("glDeleteFramebuffers");
    }
...
#if defined(GL_EXT_vertex_array)
        PFNglDrawArrays =
            (PFNGLDRAWARRAYSEXTPROC)glLoadFunction("glDrawArrays");
        PFNglDrawArraysInstanced = (PFNGLDRAWARRAYSINSTANCEDEXTPROC)glLoadFunction(
            "glDrawArraysInstanced");
#endif
#if defined(WINDOWS)
        PFNwglCreateContextAttribsARB = (PFNWGLCREATECONTEXTATTRIBSARBPROC)glLoadFunction(
            "wglCreateContextAttribsARB");
#if defined(WGL_EXT_swap_control)
        PFNwglSwapIntervalEXT =
            (PFNWGLSWAPINTERVALEXTPROC)glLoadFunction("wglSwapIntervalEXT");
#endif
#endif
    }
