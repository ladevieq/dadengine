...
namespace DadEngine::Core
{
    ...
    Application::Application()
        : m_window(m_AppInfo.m_sApplicationName,
                   m_AppInfo.m_uiWidth,
                   m_AppInfo.m_uiHeight,
                   m_AppInfo.m_bFullscreen,
                   m_AppInfo.m_bVerticalSync)
    {
    }

    Application::Application(ApplicationInfo _InAppInfo)
        : m_AppInfo(_InAppInfo), m_window(m_AppInfo.m_sApplicationName,
                                          m_AppInfo.m_uiWidth,
                                          m_AppInfo.m_uiHeight,
                                          m_AppInfo.m_bFullscreen,
                                          m_AppInfo.m_bVerticalSync)
	...
	PlatformWindow Application::GetWindow()
    {
        return m_window;
    }
