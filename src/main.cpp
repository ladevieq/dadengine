...
// struct WInput : Input
//{
//    WInput(Actor *_InPlayer) : Input(KEY_W), player(_InPlayer)
//    {
//    }
//
...
// struct SInput : Input
//{
//    SInput(Actor *_InPlayer) : Input(KEY_S), player(_InPlayer)
//    {
//    }
//
//    void Action() override final
...
// struct DInput : Input
//{
//    DInput(Actor *_InPlayer) : Input(KEY_D), player(_InPlayer)
//    {
//    }
//
//    void Action() override final
...
// struct AInput : Input
//{
//    AInput(Actor *_InPlayer) : Input(KEY_A), player(_InPlayer)
//    {
//    }
//
//    void Action() override final
...
//
//    vertexShaderReader = PlatformFileSystem::CreateFileReader("./data/test/test-multiple.vert", IO_MODE_TEXT);
//    fragmentShaderReader = PlatformFileSystem::CreateFileReader("./data/test/test-multiple.frag", IO_MODE_TEXT);
//
...
//
//    vertexShaderReader = PlatformFileSystem::CreateFileReader("./data/test/test-vk.vert.spv", IO_MODE_BINARY);
//    fragmentShaderReader = PlatformFileSystem::CreateFileReader("./data/test/test-vk.frag.spv", IO_MODE_BINARY);
//
...
//    fragmentShader =
//        renderContext->CreateFragmentShader(fragmentShaderCode.Cstr(), fragmentShaderCode.Size());
...
//
//    vb = renderContext->CreateVertexBuffer((uint32_t)triangle.m_vertices.Size(), rawPosition,
//                                           vertexLayout, uiStride);
//
...
//
//        /*Matrix4x4 pers =
//        CameraManager::GetCameraManager()->GetMainCamera()->GetProjectionMatrix(); Matrix4x4 view;
//        Vector3f eyePos =
//        CameraManager::GetCameraManager()->GetMainCamera()->m_Owner->GetRelativeLocation(); Vector3f
//        targetPosition = Vector3f{ eyePos.x, eyePos.y, -1.f }; Vector3f up = Vector3f{ 0.f, 1.f, 0.f
//        }; view.LookAt(eyePos, targetPosition, up); Matrix4x4 vp = pers * view;
//
//        Vector4f v1 = Vector4f(triangle.m_vertices[0U].Position.x,
//        triangle.m_vertices[0U].Position.y, triangle.m_vertices[0U].Position.z, 1.0); v1 = vp *
//        v1;*/
//
