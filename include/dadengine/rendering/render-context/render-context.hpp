...
namespace DadEngine
{
    ...
    class RenderContext
    {
        ...
        public:
        // Commands
        virtual void ClearColorBuffer(Color &_InClearColor,
        ...
        virtual void BindVertexBuffer(VertexBuffer *_InVertexBuffer,
                                      CommandBuffer *_InCommandBuffer) = 0;

        virtual void BindShaderProgram(Shader *_InShader,
                                       CommandBuffer *_InCommandBuffer) = 0;

        virtual void BeginRenderPass(RenderPass *_InRenderPass,
        ...
        virtual void SetCullingMode(CullingMode _InCullingMode,
                                    CommandBuffer *_InCommandBuffer) = 0;
        ...
        CreateVertexShader(const char *_InShaderCode,
                           size_t _InShaderCodeSize,
                           TArray<VertexInput> &_InVertexInputLayout) = 0;
        virtual GeometryShader *CreateGeometryShader(const char *_InShaderCode,
                                                     size_t _InShaderCodeSize) = 0;
        virtual FragmentShader *CreateFragmentShader(const char *_InShaderCode,
                                                     size_t _InShaderCodeSize) = 0;
        virtual Shader *CreateShader(VertexShader *_InVertexShader,
                                     GeometryShader *_InGeometryShader,
                                     FragmentShader *_InFragmentShader,
                                     RenderPass *_InRenderpass) = 0;
        virtual CommandBuffer *CreateCommandBuffer() = 0;
        virtual RenderPass *CreateRenderPass(TArray<Image *> &_InImage) = 0;
        virtual Framebuffer *CreateFramebuffer(Extent2D &_InFramebufferSize,
                                               RenderPass *_InRenderPass) = 0;
    };
} // namespace DadEngine
