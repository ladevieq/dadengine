...
namespace DadEngine
{
    ...
    */
    ...
    void __stdcall glBindAttribLocation(GLuint _InProgramID,
                                        GLuint _InBindIndex,
    ...
    void __stdcall glDeleteFramebuffers(GLsizei _InFramebufferCount,
                                        GLuint *_InFramebuffersIndices);
...
#if defined(WINDOWS)
    HGLRC _stdcall wglCreateContextAttribsARB(HDC _InHDC,
                                              HGLRC _InSharedHGLRC,
                                              const int *_InAttribList);
