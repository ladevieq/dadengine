...
namespace DadEngine::Rendering::VulkanDebug
{
                                        ...
                                        void *_InUserData)
    {
        ...
        {
            printf ("%s%s%s%d%s%s\n", "PERFORMANCE WARNING: [", _inPrefixLayer,
                    "] Code ", _InMessageCode, " : ", _InMessage);
        }
        ...
        {
            printf ("%s%s%s%d%s%s\n", "DEBUG: [", _inPrefixLayer, "] Code ",
                    _InMessageCode, " : ", _InMessage);
        }
    ...
    void InitializeVulkanDebug (VkInstance &_InInstance)
    {
        ...
        vkGetInstanceProcAddr (_InInstance, "vkCreateDebugReportCallbackEXT");
        DestroyDebugReportCallback = (PFN_vkDestroyDebugReportCallbackEXT)
        vkGetInstanceProcAddr (_InInstance, "vkDestroyDebugReportCallbackEXT");
        DebugReportMessage = (PFN_vkDebugReportMessageEXT)
        vkGetInstanceProcAddr (_InInstance, "vkDebugReportMessageEXT");
        ...
        VK_CHECK_RESULT (CreateDebugReportCallback (_InInstance, &debug_report_callback_create_info,
